...
Notes:
  * libQnnHtp.so and libQnnSystem.so are loaded via dlopen() at runtime from
    ...
    system partition.
  * libQnnHtpV68Stub.so is the unsigned stub required by the HTP V68 (QCS6490)
