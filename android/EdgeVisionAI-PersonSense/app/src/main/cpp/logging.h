...
#include "ggml.h"   // for enum ggml_log_level
...
// Simple compile-time log filtering (API 26+ compatible)
// __android_log_is_loggable requires API 30+, so we use a simple priority check
